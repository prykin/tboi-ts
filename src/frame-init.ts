...
function soundy(nam, vol, xxasda)
{
   ...
   if(_root.soundonce[nam] == undefined || xxasda)
   {
      ...
      if(!_init.so.data.soff || xxasda)
      {
         ...
         if(_init.f1 || nam == "bossintro.mp3" || nam == "isaacbosswin.mp3" || nam == "ambushwin.mp3" || nam == "levelbumper.mp3" || nam == "m1-2.mp3" || nam == _init.bosm || nam == "m-b0.mp3" || nam == "m-b1.mp3" || nam == "isaactitleloop.mp3" || nam == "credits1-0.mp3" || nam == "credits1-1.mp3")
         {
...
function soundfra()
{
   ...
   else if(_init._currentframe != 1 && _root._currentframe <= 5 || _init._currentframe == 20 || _init._currentframe == 21 || _init._currentframe == 24 || _init._currentframe == 41)
   {
      _init.f10 = _root._currentframe == 2 && _root.lev == _root.lib || _root._currentframe == 24;
      _init.f9 = _root._currentframe == 2 && _root.lev == _root.hide2;
      _init.f5 = _root._currentframe == 2 && _root.lev == _root.gamb;
      _init.f6 = _root._currentframe == 2 && _root.lev == _root.shopl && _root.lev != _root.minb;
      _init.f7 = _root._currentframe == 2 && _root.lev == 166 && _root.kramper != _root.chaps;
      _init.f11 = _root._currentframe == 2 && _root.lev == 166 && _root.altsat;
      _init.f8 = _root._currentframe == 2 && _root.lev == _root.hide && _root.lev != _root.minb;
      if(_root.musc == undefined && _root.amusc == undefined)
      {
         ...
         else
         {
            ...
            {
               _init.f1 = 6;
               if(_root.lev == _root.chamb && _root.altch || (_root.lev == _root.shopl || _root.lev == _root.minb) && _root.altm)
               {
                  _init.f1 = 27;
               }
      ...
      else if(_root.mmus == undefined && _root.musc.s.getVolume() < _init.mvol)
      {
         if(!_root.musc.wait)
         {
      ...
      if(_root.musc.nam != undefined && !_init.fader)
      {
         if(_root.bossmusic)
         {
            if(_root.lev != _root.bossl && _root.bossl2 != _root.lev && _root.lev != _root.gamb && (_root.lev != 166 || _root.kramper != _root.chaps) && _root.lev != _root.minb && _root.lev != _root.chamb && _root._currentframe != 4)
            {
               _root.bossmusic = false;
               _init.fade = true;
            }
         ...
         if(_init.f5 && _root.musc.nam != "m12-1.mp3" && _root.musc.nam != "m12-0.mp3")
         {
            _root.fade = true;
         }
         if(!_init.f5 && (_root.musc.nam == "m12-1.mp3" || _root.musc.nam == "m12-0.mp3"))
         ...
         if(_init.f6 && _root.musc.nam != "m13-0.mp3" && _root.musc.nam != "m13-1.mp3")
         {
            _root.fade = true;
         }
         if(!_init.f6 && (_root.musc.nam == "m13-0.mp3" || _root.musc.nam == "m13-1.mp3"))
         ...
         if(_init.f7 && _root.musc.nam != "m14-0.mp3" && _root.musc.nam != "m14-1.mp3")
         {
            _root.fade = true;
         }
         if(!_init.f7 && (_root.musc.nam == "m14-0.mp3" || _root.musc.nam == "m14-1.mp3"))
         ...
         if(_init.f8 && _root.musc.nam != "m15-0.mp3" && _root.musc.nam != "m15-1.mp3")
         {
            _root.fade = true;
         }
         if(!_init.f8 && (_root.musc.nam == "m15-0.mp3" || _root.musc.nam == "m15-1.mp3"))
         ...
         if(_init.f9 && _root.musc.nam != "m28-0.mp3" && _root.musc.nam != "m28-1.mp3")
         {
            _root.fade = true;
         }
         if(!_init.f9 && (_root.musc.nam == "m28-0.mp3" || _root.musc.nam == "m28-1.mp3"))
         ...
         if(_init.f10 && _root.musc.nam != "m30-0.mp3" && _root.musc.nam != "m30-1.mp3")
         {
            _root.fade = true;
         }
         if(!_init.f10 && (_root.musc.nam == "m30-0.mp3" || _root.musc.nam == "m30-1.mp3"))
         ...
         if(_init._currentframe != 20 && _init._currentframe != 21 && (_root.musc.nam == "credits1-0.mp3" || _root.musc.nam == "credits1-1.mp3" || _root.musc.nam == "m11-0.mp3" || _root.musc.nam == "m11-1.mp3"))
         {
            _root.fade = true;
         }
         if((_init._currentframe == 20 || _init._currentframe == 21) && (_root.musc.nam != "credits1-0.mp3" && _root.musc.nam != "credits1-1.mp3" && _root.musc.nam != "m11-0.mp3" && _root.musc.nam != "m11-1.mp3"))
   ...
   for(let e in _init.sz)
   {
      ...
      if(_init.trg.looper && _init.trg.s.duration - _init.lop2 < _init.trg.s.position)
      {
         _init.trg.s.stop();
         _init.trg.s.start(_init.lop,0);
      }
      if(_root.musc == _init.trg && _init.trg.s.duration - _init.lop2 < _init.trg.s.position)
      {
         _init.trg.s.stop();
         _init.trg.done = true;
         _root.musc = undefined;
      }
      if(_root.musc == _init.trg && _init.trg.wining && _init.trg.s.duration - 2500 < _init.trg.s.position)
      {
         _root.musc = undefined;
      }
      if(_root.mmus == _init.trg && _init.trg.s.duration - 1000 < _init.trg.s.position)
      {
         _root.mmus = undefined;
      }
      if(_init.trg.s.duration == _init.trg.s.position && !_init.trg.looper && !_init.trg.looper2 || _init.trg.done)
      {
...
function fullf(f1)
{
   ...
   else if(_init.win || _init.macVersion != undefined)
   {
      ...
      if(!_init.so.data.full)
      {
         ...
         this.mdm.Forms.thisForm.x = (f1[0] - this.mdm.Forms.thisForm.width) / 2 - 2;
         this.mdm.Forms.thisForm.y = (f1[1] - this.mdm.Forms.thisForm.height) / 2 - 20;
      }
   }
   else
   {
...
function callit(f1)
{
   if(!_init.linx)
   {
      ...
      if(_init.win)
      {
         var _loc3_ = this.mdm.Process.create("My App",0,0,500,600,"",_loc2_ + "FlashAchievements.exe " + f1,_loc2_,2,4);
      }
      else
      {
         if(_init.fuk)
         ...
         _init.fuk = !_init.fuk;
         _loc3_ = this.mdm.Process.create("My App",0,0,500,600,"",_loc2_ + "FlashAchievements " + f1,_loc2_,2,4);
      }
   }
}
function doit(trg)
...
function init_onEnterFrame()
{
   ...
   if(Key.isDown(32) && (_init._currentframe == 3 && _init.d._currentframe > 5 || _init._currentframe == 4 && _init.d._currentframe > 21))
   {
      _root.gotoAndStop("game");
      _root.fade = true;
   }
   ...
   if(Key.isDown(32) && (_init._currentframe == 21 || _init._currentframe == 7 || _root.creskip && _init._currentframe == 20) && !_init.ffs1)
   {
      _root.creskip = false;
   ...
   if(Key.isDown(32) && (_init._currentframe > 9 && _init._currentframe < 20 || _init._currentframe == 22 || _init._currentframe == 23) && !_init.ffs1)
   {
...
function init()
{
   ...
   else
   {
      ...
      _init.win = (_init.macVersion + " ").indexOf("type Function") > 0 || _init.winVersion > 0;
   ...
   _init.lasf = 0;
   _init.refs = [[0],[800,600],[720,480],[640,480],[1280,800],[1280,720],[1024,768]];
   _init.overlay2._alpha = 0;
   _init.ala = 0;
