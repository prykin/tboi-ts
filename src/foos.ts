import {attachMovie, createEmptyMovieClip, gotoAndStop, int, removeMovieClip} from "@/flash";
...
function gish(trg, f1) {
    if (f1 == 2) {
        if (
            trg._parent._parent == player ||
            trg._parent._parent._parent == player ||
            trg._parent._parent._parent._parent == player ||
            trg._parent._parent._parent._parent._parent == player
        ) {
            f1 = 3;
        }
    }
...
export function create(f1, f2, f3, f4, f5, f6, f7, f9?) {
    ...
    if (_root.locker[3] || _root.lev % 4 == 0 || _root.hardmode) {
        ...
        gobo = false;
        if (
            (((spezz == 23 || (!noetern && !spezz && _root.hardmode)) &&
                    (!gospo || fra > 10)) ||
                allets) &&
...
function golev() {
    ...
    for (e in door) {
        ...
        if (_this.error) {
            ...
            _root.lev == _root.bossl &&
            !trg._visible &&
            (Math.abs(e - _root.door) == 2 || e == _root.door || _root.door <= 0) &&
            !sat
        ) {
            sat = true;
            trg._visible = true;
        ...
        if (trg._visible || trg.govo) {
            ...
            if (trg.gol == _root.cus || _root.lev == _root.cus) {
                ...
                (_root.lev == _root.hide && (_root.lastl == trg.gol || ups[76])) ||
                (ups[76] &&
                    trg.gol == _root.hide &&
                    _root.lev != _root.bossl2 &&
                    _root.lev != _root.bossl &&
                ...
                (trg.gol == _root.hide || _root.lev == _root.hide) &&
                !_this.satan
            ) {
                trg.hide = true;
                trg._visible = trg.govo;
                ...
                (trg.gol == _root.hide2 || _root.lev == _root.hide2) &&
                !_this.satan
            ) {
                trg.hide2 = true;
                trg._visible = true;
...
function powerlevel() {
    ...
    if (!highs.empty && fra - lastcra >= 30) {
        ...
        if (
            (highs.it >= 33 && highs.it != 46 && highs.it != 48 && highs.it < 50) ||
            highs.it == 56 ||
            highs.it == 58 ||
            highs.it == 65 ||
            highs.it == 66 ||
        ...
        if (_root.keys >= 1 || _root.kep || highs.d._currentframe != 6) {
            ...
            if (_root.hardmode) {
                if (random(Math.max(10 + _root.luck, 1)) == 0) {
                    if (
                        highs.d._currentframe == 4 &&
                        (highs.col == 1 || highs.col == 2)
                    ) {
                        highs.dones = false;
            ...
            if (
                highs.d._currentframe < 7 &&
                ((highs.col != 3 && highs.col != 5) || highs.d._currentframe != 4)
            ) {
                if (highs.c2) {
            ...
            switch (highs.d._currentframe) {
                ...
                case 8:
                    if (highs.col == 31) {
                        ...
                        if (
                            ...
                            !highs.spin &&
                            !highs.busted &&
                            (highs.col != 10 || highs.yp - lows.yp < 0)
                        ) {
                            _root.coins = _root.coins - 1;
                            if (highs.col == 10) {
                ...
                case 9:
                    if (
                        highs.d.d._currentframe > 10 &&
                        highs.d.d._currentframe < 24 &&
                        highs.open
                    ) {
                        player._visible = false;
                        plxxx = highs.xp;
                ...
                case 15:
                    ...
                    if (
                        ...
                        (_this.satan && (_root.armor >= 3 || highs.d.d._currentframe != 11))
                    ) {
                        if (_this.satan) {
    ...
    if (trg.s != 2 || trg2.s != 2) {
        ...
        if (tests.getPixel(f1, f2) == 0) {
            ...
            if (!nohit && !trg.dones && !trg2.dones) {
                ...
                if (
                    highs.s == 5 &&
                    ((highs.col == 10 && highs.d._currentframe == 8) ||
                        highs.d._currentframe == 34)
                ) {
                        ...
                        if (
                            ...
                            if (!nohit) {
                                ...
                                if (lows.s == 2 || v6) {
                                    ...
                                    if (!lows.hh[highs.e]) {
                                        ...
                                        if (highs.eternal) {
                                            ...
                                            if (highs.s == 62) {
                                                if (
                                                    !(
                                                        (highs.worm == 1 && highs.d._currentframe == 8) ||
                                                        altboss
                                                    )
                                                ) {
                                                    if (highs.worm != 6) {
                                            ...
                                            if (
                                                ...
                                                refl.push(
                                                    lows.xp,
                                                    lows.yp,
                                                    -lows.xbew * f9 + highs.xbew * 0.8,
                                                    -lows.ybew * f9 + highs.ybew * 0.8
                                                );
                                                nohit = true;
                                    ...
                                    highs.s != 28 &&
                                    (lows != player || (highs.s != 41 && highs.s != 23))
                                ) {
                                    trg.gh = 2;
                                    trg2.gh = 2;
                                }
...
function randrun() {
    ...
    if (trg.xpp != undefined) {
        if (
            trg.s != 64 &&
            (trg.s != 66 || trg.d._currentframe < 7) &&
            trg.s != 77 &&
            trg.s != 76 &&
            trg.s != 79
        ) {
...
function randruny() {
    ...
    if (fra < 60 && trg.eternal) {
        ...
        if (
            (trg.s != 86 || trg.d._currentframe < 3) &&
            (trg.alter != 2 || trg.wait++ > 15)
        ) {
    ...
    if (trg.xpp != undefined) {
        ...
        if (trg.d.d._currentframe + 6 > trg.d.d._totalframes) {
            ...
            if (speed >= 0.75) {
                if (
                    f1 > 10 &&
                    trg.d.d._currentframe > 13 &&
                    trg.d.d._currentframe + 9 < trg.d.d._totalframes
                ) {
                    trg.d.d.prevFrame();
                    if (f1 > 25) {
                        trg.d.d.prevFrame();
        ...
        while (a < 4) {
            ...
            if (f1) {
                ...
                if (
                    (trg.flyby && trg.s != 19 && trg.s != 89) ||
                    (levzz(f5) < 0.2 &&
                        (levzz(f3) < 0.2 || levzz(f4) < 0.2 || random(8) == 0))
                ) {
                    f8[a] = i;
                }
            } else {
...
function ffmo(f1, f2, f3, f4, f5, f6, f7, f8?, huh?, huh2?) {
    ...
    if (
        ...
        (trg.s == 65 && altboss) ||
        (trg.s == 102 && (trg.state > 0 || (altboss && random(5) == 0 && !noho))) ||
        (trg.minb == 3 && trg.specoz != 23) ||
        (trg.s == 98 && trg.specoz == 18) ||
    ...
    if (
        trg.special ||
        trg.s == 59 ||
        (trg.s == 57 && (trg.alter == 2 || !trg.eternal)) ||
        trg.s == 53 ||
        trg.s == 43 ||
        trg.s == 75 ||
        trg.s == 76 ||
...
function firemode(siz, f1, f2?) {
    ...
    if (trg.s == 38 && trg.eternal && trg.alter == 3) {
        ...
        (trg.fir++ > 0 &&
            (trg.s != 79 || trg.d.d._currentframe == 17) &&
            (trg.s != 63 ||
                trg.d.d._currentframe == 19 ||
                (trg.d.d._currentframe == 24 && trg.specoz == 23)) &&
            (trg.s != 27 || trg.d._currentframe == 5) &&
            trg.s != 56) ||
...
function gosplash() {
    ...
    if (
        trg.s == 4 ||
        ((trg.s == 45 || trg.s == 101 || trg.s == 84) && !trg.dones)
    ) {
            ...
            if (
                ...
                if (trg2.s != 5 || fra - trg2.fra > 30 || f1) {
                    ...
                    if (f2) {
                        ...
                        if (
                            !(
                                (((trg2.specoz == 23 && trg.s != 101) ||
                                        trg2.s == 46 ||
                                        trg2.s == 68 ||
                                        (trg2.s == 87 && trg.pois != 10) ||
                                        trg2.s == 67 ||
                                        (trg2.s == 30 && trg.s != 101) ||
                                        trg2.s == 88 ||
                                        trg2.s == 59 ||
...
function firr(trg) {
    var _loc3_ =
        ups[6] * 1.5 +
        (ups[32] + ups[80] + ups[1] + ups[120]) * 0.7 +
        (ups[196] + ups[59] - ups[182] * 2.3) * 0.4 +
        (ups[101] + ups[90] + ups[189]) * 0.2;
    if (ups[120]) {
        _loc3_ = _loc3_ + 1;
    }
    if (_root.skiner == 6) {
...
function plff() {
    ...
    if (
        trg.fire < 0 &&
        ((!ups[69] && !ups[118]) || chaz || _root.bombnext) &&
        unic <= 0 &&
        (xenf != 0 || yenf != 0)
    ) {
        firr(trg);
...
function friends() {
    ...
    if (!trg.stopi) {
        if (trg.hairb) {
            ...
            if (
                trg.d._currentframe != 149 ||
                trg.d.d._currentframe == trg.d.d._totalframes
            ) {
    ...
    if (momdown-- > 0) {
        if (_root.chaps == 6) {
            ...
            if (
                ...
                //&& _root.chaps != 7 //it's always true
            ) {
                _root.locker[4] = true;
                _root.locker[5] = true;
                _root.locker[6] = true;
...
function deathscripts() {
    ...
    if (
        (trg.s == 61 ||
            (trg.s == 26 && trg.alter == 2) ||
            (trg.s == 92 && trg.eternal) ||
            (trg.s == 22 && trg.eternal == 2)) &&
        trg.dones &&
        !trg.wtfsto
    ) {
        trg.wtfsto = true;
        if (trg.alter == 2 && trg.s == 61) {
            ...
            quadf(
                ...
                trg.yp,
                8,
                (trg.s == 26 && trg.alter == 2 && trg.eternal) ||
...
function alive() {
    ...
    if (
        ...
        trg.s != 96 &&
        !trg.efly &&
        (((_root.lev == _root.chamb || trg.s != 18) && trg.s != 85) || justnow < 10)
    ) {
        shutdoor++;
    }
                        ...
                        if (trg.s == 8) {
                            if (random(3) == 0) {
                                splater(
                                    ...
                                    trg.yp,
                                    trg.spl + 1 + random(10),
                                    ((Math.random() * 0.3 + 0.1) * trg.d._xscale) / 100
                                );
                            }
                        }
                    case 7:
...
function bawssmart2() {
    switch (trg.s) {
        ...
        case 77:
            ...
            if (trg.d._currentframe == 13 && trg.d.d._currentframe == 17) {
                if (trg.eternal && Math.abs(trg._xscale) > 120) {
                    ...
                    cirf(
                        ...
                        trg.yp + 20,
                        8,
                        Math.round(4 + Math.abs(trg._xscale) / 40)
                    );
            ...
            if (
                (trg.d._currentframe == 2 ||
                    trg.d._currentframe == 7 ||
                    trg.d._currentframe == 8) &&
                trg.d.d._currentframe == 22
            ) {
                _root.soundy("ForestBoss_Stomps" + random(3) + ".wav", 80);
            }
            ...
            trg.bh =
                (trg.d._currentframe != 4 || trg.d.d._currentframe < 11) &&
                (trg.d._currentframe != 5 || trg.d.d._currentframe > 21);
            switch (trg.d._currentframe) {
                case 10:
                    if (trg.d.d._currentframe == 1) {
                        if (random(2) == 0) {
                ...
                case 9:
                    if (
                        (trg.s == 75 && trg.d.d._currentframe == 19) ||
                        (trg.s == 74 && trg.d.d._currentframe == 30)
                    ) {
                        if (trg.s == 74) {
                            f1 = 30;
                        } else {
...
function bawssmart() {
    switch (trg.s) {
        ...
        case 101:
            ...
            trg.bh =
                (trg.d._currentframe != 4 || trg.d.d._currentframe < 21) &&
                (trg.d._currentframe != 5 || trg.d.d._currentframe > 6) &&
                (trg.d._currentframe != 7 ||
                    (trg.d.d._currentframe > 16 && trg.d.d._currentframe < 37)) &&
                (trg.d._currentframe != 6 ||
                    (trg.d.d._currentframe < 6 && trg.d.d._currentframe > 73));
            if (
                (trg.d._currentframe == 5 && trg.d.d._currentframe == 9) ||
        ...
        case 100:
            ...
            if (
                trg.specoz == 20 &&
                fra2 &&
                (trg.d.d._currentframe != 9 || trg.d._currentframe != 7)
            ) {
                trgnextd();
            }
            f1 = 0.8;
...
function smarts3() {
    switch (trg.s) {
        ...
        case 20:
            ...
            if (trg.specoz == 23 && trg.s == 20) {
                if (
                    (trg.hp < trg.mhp * 0.25 && trg._yscale > 70) ||
                    (trg.hp < trg.mhp * 0.5 && trg._yscale >= 110)
                ) {
                    sizes[20] = 24;
                    xenf = 20;
            ...
            trg.bh =
                (trg.d._currentframe != 6 ||
                    trg.d.d._currentframe > 22 ||
                    trg.d.d._currentframe < 8) &&
                (trg.d._currentframe != 2 || trg.d.d._currentframe < 8) &&
                (trg.d._currentframe != 3 || trg.d.d._currentframe > 33) &&
                trg.d._currentframe != 5;
            whuf =
                ((trg.s == 43 && fra2 && trg.specoz == 14) ||
                    (trg.specoz == 23 &&
                        trg.s == 20 &&
                        fra2 &&
                        trg.d.currentframe != 4 &&
                        !trg.splity)) &&
                !trg.weap;
            if (trg.weap) {
                trgnextd();
                ...
                switch (trg.mode) {
                    ...
                    case 3:
                        ...
                        if (
                            trg.d.d._currentframe == 33 ||
                            (trg.d.d._currentframe == 34 && whuf)
                        ) {
                            f3 = 5;
                            if (trg.s == 43) {
                                f1 = trg.xp;
                    ...
                    default:
                        if (trg.fra + 10 > fra) {
                            ...
                            if (trg.s == 43 && !altboss) {
                                ...
                                trg.mode = random(3);
                                if (
                                    (trg.specoz == 2 || (trg.specoz == 23 && trg._yscale < 70)) &&
                                    trg.mode == 2 &&
                                    trg.s == 20
                                ) {
                                    trg.mode = 1;
...
function smarts4() {
    switch (trg.s) {
        ...
        case 21:
            ...
            if (
                (trg.s == 23 || trg.s == 21) &&
                (trg.d._currentframe == 9 || trg.coon > 0)
            ) {
                bord();
                trg.xbew *= 0.8;
                trg.ybew *= 0.8;
        ...
        case 86:
            if (trg.flyby) {
                if (trg.d._currentframe < 5) {
                    ...
                    if (
                        (trg.d._currentframe == 5 && trg.d.d._currentframe > 6) ||
                        (trg.d._currentframe == 6 && trg.d.d._currentframe < 18)
                    ) {
                        trg.f1 += 0.02;
                            ...
                            default:
                                if (altboss == 2 && trg.hp / trg.mhp < 0.3 && !trg.specoz) {
                                    ...
                                    if (
                                        ...
                                        random(100 - nomag) == 0 &&
                                        ((ashut < f2 && !f1) ||
                                            (f1 && chubber < 5 && fra >= lastpoop)) &&
                                        (trg.specoz != 8 || ashut < 4 || random(4) == 0)
                                    ) {
                                        _root.soundy("Monster_Roar_1.mp", 100);
                                        lastpoop = fra + 100;
                                        trg.mode = 3;
...
function ssmarts() {
    switch (trg.s) {
        case 45:
            ...
            trg.bh =
                (trg.d._currentframe == 20 &&
                    trg.d.d._currentframe > 27 &&
                    trg.d.d._currentframe < 62) ||
                trg.d._currentframe == 19;
            if (
                (trg.d._currentframe == 20 && trg.d.d._currentframe == 26) ||
                trg.whu == 3
            ) {
                trg.whu = 0;
                trg.dmg = 300;
        ...
        case 46:
            ...
            if (trg.d._currentframe < 3) {
                ...
                if (random(50) == 0) {
                    if (
                        (random(2) == 0 && ashut < 4) ||
                        (Math.abs(trg.yp - player.yp) > 60 && trg.minb == 3)
                    ) {
                        trg.d.gotoAndStop(6);
    ...
    if ((_loc0_ = trg.s) === 79) {
        ...
        if (trg.alt) {
            ...
            if (altboss == 2) {
                ...
                trg2.dones ||
                (altboss && trg2.trg3 != trg && trg2.hp < 60) ||
                trg.onown
            ) {
                bord(580, 60, 410, 170);
                if (!trg.onown) {
...
function smux2() {
    switch (trg.s) {
        case 78:
            ...
            if (
                trg.d._currentframe != 5 &&
                (trg.d._currentframe != 4 || trg.d.d._currentframe > 30)
            ) {
            ...
            trg.bh =
                trg.d._currentframe != 5 &&
                (trg.d._currentframe != 4 || trg.d.d._currentframe > 5);
            if (ashut < 2) {
                trg.fire--;
            }
            ...
            switch (trg.d._currentframe) {
                ...
                case 2:
                    ...
                    if (
                        ...
                        ((random(50) == 0 && trg.specoz == 23) || random(50) == 0) &&
                        ashut < 3 + random(2) &&
                        (random(3) == 0 || !altboss)
                    ) {
                        trg.d.gotoAndStop(8);
                ...
                case 7:
                    ...
                    if (trg.specoz == 23) {
                        ...
                        if (
                            (trg.d.d._currentframe > 36 && trg.d.d._currentframe < 49) ||
                            (trg.d.d._currentframe > 60 && trg.d.d._currentframe < 75)
                        ) {
                            trg.d.d.nextFrame();
                            trg.d.d.nextFrame();
                        }
        ...
        case 68:
                ...
                case 2:
                    ...
                    if (trg.specoz != 12 || random(3) == 0) {
                        ...
                        if (altboss) {
                            ...
                            if (
                                Math.abs(trg.xp - player.xp - player.xbew * 5) < 40 &&
                                trg.yp < player.yp
                            ) {
                                trg.d.gotoAndStop(13);
                            }
            ...
            trg.bh = _loc0_ =
                (trg.d._currentframe != 10 || trg.d.d._currentframe < 29) &&
                (trg.d._currentframe != 11 || trg.d.d._currentframe > 27);
            if (_loc0_) {
                if (trg.specoz == 12) {
                    trg.xbew *= 0.8;
                    trg.ybew *= 0.8;
                ...
                case 2:
                    if (random(40) == 0 && dukes + ashut < 9 && trg.specoz != 19) {
                        ...
                        (random(45) == 0 &&
                            ...
                            ashut - dukes < 5 &&
                            trg.specoz != 5) ||
                        ((trg.specoz == 5 || altboss) && random(70) == 0) ||
                        (trg.specoz == 19 && random(20) == 0)
                    ) {
                        trg.d.gotoAndStop(7);
                    }
                    break;
                        ...
                        switch (trg.d._currentframe) {
                            case 4:
                                ...
                                if (
                                    (xenf * xenf1 < 0 &&
                                        yenf > -70 &&
                                        (trg.llo != 6 || random(10) == 0)) ||
                                    (trg.llo == 7 && Math.abs(xenf) < 40 && random(3) == 0)
                                ) {
                                    trg.d.gotoAndStop(6);
                                    ...
                                    random(15) == 0 ||
                                    (random(3) == 0 && (trg.llo == 7 || trg.llo == 6))
                                ) {
                                    trg.d.gotoAndStop(5);
                                    trg.llo = 5;
            ...
            switch (trg.d._currentframe) {
                ...
                case 2:
                    ...
                    if (
                        ...
                        ((Math.abs(trg.yp - player.yp) < 20 &&
                                (Math.abs(trg.xp - player.xp) > 100 || trg.specoz != 23)) ||
                            (trg.specoz == 7 && random(4) == 0)) &&
                        random(5) == 0 &&
                        trg.speczo != 23
                    ) {
                        _root.soundy("Monster_Yell_A_" + random(3) + ".mp", 100);
                ...
                case 5:
                    if (trg.specoz == 23) {
                        ...
                        if (
                            trg.d.d._currentframe == 25 ||
                            ((trg.d.d._currentframe == 27 || trg.d.d._currentframe == 29) &&
                                trg.fire != 0)
                        ) {
                            _root.soundy("Monster_Grunt_5.mp", 100);
                            if (trg.fire != 0) {
                                ...
                                cirf(
                                    ...
                                    8,
                                    3,
                                    (trg.fire + trg.d.d._currentframe) * 0.2
                                );
                                trg.s = 63;
                            } else {
                                xenf = crand(50);
        ...
        case 62:
            ...
            if (trg.worm == 1) {
                if (trg.d._currentframe == 8 || trg.d._currentframe == 9) {
                    ...
                    trg.bh = true;
                    if (
                        (trg.d._currentframe == 8 && trg.d.d._currentframe > 88) ||
                        (trg.d._currentframe == 9 && trg.d.d._currentframe > 55)
                    ) {
                        trg.bh = false;
                    }
                    trg._visible = true;
                ...
                (trg.worm == 7 && trg.specoz != 23) ||
                (trg.specoz == 23 && trg.worm == 9)
            ) {
                trg.bh = false;
                f1 = worm[1].xppp;
                if (f1 > 0) {
                ...
                case 9:
                    ...
                    if (
                        ...
                        ((ashut < 3 && trg.specoz != 23) ||
                            ((ashut < 3 || !trg.nogrow) && trg.specoz == 23))
                    ) {
                        trg.nogrow = true;
                        trg.d.gotoAndStop(10);
                    }
                ...
                case 2:
                    ...
                    if (
                        ...
                        ((ashut < 2 + random(2) && trg.specoz != 23) ||
                            (ashut < 7 && trg.specoz == 23 && trg.lastdd != 5))
                    ) {
                        trg.d.gotoAndStop(5);
                        trg.lastdd = 5;
                        ...
                        random(100) == 0 &&
                        ((ashut < 5 && trg.specoz != 23) ||
                            (ashut < 7 && trg.specoz == 23 && trg.lastdd != 14))
                    ) {
            ...
            switch (trg.d._currentframe) {
                ...
                case 2:
                    ...
                    if (random(90) == 0 && f1 < 200) {
                        ...
                        random(180) == 0 ||
                        (ashut > 5 && trg.specoz == 23 && random(30) == 0)
                    ) {
                        trg.d.gotoAndStop(6);
                ...
                case 8:
                    if (trg.specoz) {
                        ...
                        if (
                            (fra % 45 == 0 ||
                                (fra % 15 == 0 && trg.specoz == 23 && !altboss)) &&
                            ((anarch <= -80 && trg.loap && trg.specoz != 23) ||
                                (trg.specoz == 23 && trg.loap))
                        ) {
                            if (trg.specoz == 23) {
                                if (altboss || true) {
                                    if (ashut < 7) {
    ...
    switch (trg.s) {
        ...
        case 19:
            ...
            if (!trg.donelook) {
                    ...
                    if (trg2.s == 19 || trg2.s == 89) {
                        if (
                            ...
                            if (
                                trg.trg3 != trg2 &&
                                trg.trg3.trg3 != trg2 &&
                                trg.trg3.trg3.trg3 != trg2 &&
                                trg.trg3.trg3.trg3.trg3 != trg2 &&
                                trg.trg3.trg3.trg3.trg3.trg3 != trg2
                            ) {
                                trg.trg2 = trg2;
                                trg.lar = trg2.lar + 1;
                                trg2.trg3 = trg;
                ...
                if (trg.trg2.s == 19 || trg.trg2.s == 89) {
                    ...
                    if (trg2.dones && trg.s == 19) {
                        ...
                        (trg2.dones || trg2.frei || trg.frei || trg.trg3.frei) &&
                        trg.s != 19
                    ) {
                        trg.trg3.frei = true;
                        trg.trg2 = undefined;
            ...
            if (trg.s == 19 && !altboss) {
                if (trg.whop <= 0) {
                    if (
                        (_root.lev != _root.chamb || trg.eternal) &&
                        fra > 20 &&
        ...
        case 15:
            ...
            switch (trg.mode) {
                case 1:
                    if (
                        (trg.d._currentframe == 1 && trg.modedone) ||
                        (random(30) == 0 && fra - trg.mof > 30)
                    ) {
                        trg.mode = 2;
                        trg.modedone = false;
                    } else {
                        ...
                        if (
                            (trg.d.d._currentframe > 10 && !trg.modedone) ||
                            (trg.d._currentframe == 6 &&
                                (trg.d.d._currentframe == 11 ||
                                    trg.d.d._currentframe == 18 ||
                                    trg.d.d._currentframe == 27))
                        ) {
                            if (trg.alter == 3) {
        ...
        case 38:
            ...
            if (
                ...
                if (trg.telp > 20) {
                    ...
                    if (
                        (trg.d._currentframe == 1 ||
                            (trg.d._currentframe == 5 &&
                                trg.d.d._currentframe > 17 &&
                                trg.eternal)) &&
                        (trg.telp > 40 || (trg.eternal && trg.telp > 28)) &&
                        trg.xpp != undefined
                    ) {
                        trg.d.gotoAndStop(6);
                    }
        ...
        case 59:
            ...
            if (
                ((trg.d._currentframe == 2 || trg.d._currentframe == 5) &&
                    trg.d.d._currentframe == 29) ||
                (trg.d._currentframe == 6 && trg.d.d._currentframe == 5)
            ) {
        ...
        case 60:
            ...
            if (trg.d._currentframe == 1) {
                if (trg.spinny > 0) {
                    ...
                    f1 =
                        rotget2(
                            trg.xp - player.xp - player.xbew * 1,
        ...
        case 42:
            if (trg.s == 27) {
                if (
                    (trg.d._currentframe == 5 || trg.d._currentframe == 6) &&
                    (trg.d.d._currentframe == 9 || trg.d.d._currentframe == 55)
                ) {
                    _root.soundy("animal_squish" + random(3) + ".wav", 100);
                }
                if (trg.eternal) {
            ...
            if (trg.s == 56) {
                ...
                trg.bh =
                    trg.d._currentframe != 5 ||
                    (trg.d.d._currentframe > 11 && trg.d.d._currentframe < 54);
                if (
                    trg.d._currentframe == 5 &&
                    (trg.d.d._currentframe == 11 || trg.d.d._currentframe == 54)
                ) {
        ...
        case 10:
            ...
            if (trg.s == 58) {
                trg.bh =
                    (trg.d._currentframe != 5 || trg.d.d._currentframe > 3) &&
                    (trg.d._currentframe != 6 || trg.d.d._currentframe < 7);
                if (
                    (trg.d._currentframe == 5 && trg.d.d._currentframe == 3) ||
                    (trg.d._currentframe == 6 && trg.d.d._currentframe == 7)
                ) {
                ...
                if (trg.s == 58) {
                    if (!trg.eternal) {
                        ...
                        if (trg.spoo > 0) {
                            if (
                                trg.spoo == 10 ||
                                (trg.spoo == 20 && fra < 5000) ||
                                (trg.spoo == 30 && fra < 2500)
                            ) {
                                b1 = allets;
                                allets = false;
                                enf = enfcheck(trg.xp, trg.yp, player.xp, player.yp, 1000);
            ...
            switch (trg.s) {
                ...
                default:
                    ...
                    if (trg.s == 102) {
                        ...
                        if (
                            trg2._currentframe == 66 ||
                            trg2._currentframe == 15 ||
                            trg2._currentframe == 18 ||
                            trg2._currentframe == 21 ||
                            trg2._currentframe == 24 ||
                            trg2._currentframe == 28 ||
                            trg2._currentframe == 32 ||
                            trg2._currentframe == 38 ||
                            trg2._currentframe == 44 ||
                            trg2._currentframe == 51 ||
                        ...
                        if (
                            trg2._currentframe == 66 ||
                            trg2._currentframe == 3 ||
                            trg2._currentframe == 6 ||
                            trg2._currentframe == 9 ||
                            trg2._currentframe == 12 ||
                            trg2._currentframe == 15 ||
                            trg2._currentframe == 19 ||
                        ...
                        if (
                            trg2._currentframe > 70 - trg.mag * 18 &&
...
function piller() {
    ...
    while (f1 == undefined) {
        if (
            f1 == undefined ||
            (f1 == 3 && ups[75]) ||
            (f1 == 6 && (!f10 || player.hp < 1))
        ) {
            if (
                (player.hp < player.mhp || (_root.skiner == 4 && _root.armor < 3)) &&
                random(10) == 0
            ) {
                f1 = 1;
            } else if (random(13) == 0) {
    ...
    if (trg.dones) {
        ...
        if (laser <= 1) {
            if (xenf != 0 || yenf != 0) {
                if (
                    plox <= 8 &&
                    (!ups[118] || trg.fire <= 0 || chaf == undefined || _root.bombnext)
                ) {
                    if (Math.abs(xenf) > Math.abs(yenf)) {
                        yenf = 0;
                        if (xenf > 0) {
        ...
        if (ups[118] && trg.d.d.d.d._currentframe > 4) {
            ...
            if (
                trg.d.d.d.d.z._currentframe == 4 ||
                trg.d.d.d.d.z._currentframe == 11
            ) {
                brim = true;
                lasershow(trg);
                yenf = _loc0_ = 0;
        ...
        if (trg.d._currentframe == 1 || _root.bombnext) {
            ...
            if (trg.d._currentframe == 1) {
                ...
                if (ups[68]) {
                    ...
                    if (Math.abs(trg.xpp) > Math.abs(trg.ypp)) {
                        f1 =
                            (lass / trg.d.d._xscale / trg._xscale) * 10000 +
                            (trg2._x - 6) * trg.xpp;
                    } else {
                        f1 =
                            (lass / trg.d.d._xscale / trg._xscale) * 10000 +
        ...
        _root.playsp =
            ...
            Math.min(
                ...
                (ups[119] +
                    ...
                    ups[189]) *
                0.3 +
                Math.min(1, ups[14]) * 0.6 -
                Math.min(1, ups[13] + ups[121]) * 0.1 +
                f10[_root.skiner] +
                ups[70] * 0.4 +
                ups[79] * 0.2 +
                ups[82] * 0.3
            ) -
            (ups[90] + ups[129] + ups[118] + ups[182]) * 0.2;
        if (_root.it == 16) {
            _root.playersp += 0.4;
        }
        if (unic > 0) {
        ...
        yenf *= 0.75 + f1 * 0.25;
        nomove =
            (trg.d._currentframe >= 3 &&
                trg.d._currentframe < 9 &&
                (trg.d._currentframe != 4 || trg.d.d.d._currentframe < 38)) ||
            fra < 20;
        if (trg.d._currentframe == 4) {
            if (xenf != 0 || yenf != 0) {
...
let onEnterFrame = () => {
    ...
    player.d.bub2._visible =
        ups[108] || ups[162] || ups[173] || ups[142] || ups[184];
    if (ups[184]) {
                        ...
                        if (_root.altch) {
                            if (_root.altch == 2) {
                                ...
                                if (_root.chaps < 3) {
                                    ...
                                    if (
                                        (random(3) == 0 && chama == 1 && _root.noff != -1) ||
                    ...
                    if (_root.bossl == _root.lev || _root.bossl2 == _root.lev) {
                        ...
                        if (f1 > 0.22) {
                            if (f1 < 0.3) {
                                ...
                                f1 < 0.58 ||
                                (random(30 - _root.luck * 2) == 0 && player.hp < player.mhp - 1)
                            ) {
                                f0 = 5.01;
                                if (
    ...
    if (!unpause) {
        if (unlo) {
            ...
            unlo = false;
            if (
                (player.d._currentframe != 4 || player.d.d.d._currentframe > 9) &&
                (player.d._currentframe != 11 || player.d.d.d._currentframe > 9)
            ) {
                scerf();
            }
        ...
        if (qqua) {
            ...
            if (
                (wtfps > 29.4 && _quality == "MEDIUM") ||
                (wtfps > 25 && _quality == "LOW")
            ) {
                if (wtff++ > 100) {
                    wtff = 0;
                    if (_quality == "MEDIUM") {
                    ...
                    if (trg.gold) {
                        ...
                        while (z < f10 && !trg.done) {
                            ...
                            if (f2 > 0) {
                                ...
                                (((_root.locker[18] && random(10) == 0 && trg == 2) ||
                                        (random(5) == 0 && trg.d._currentframe == 6)) &&
                                    z == 0 &&
                                    (trg != 2 || !ups[90])) ||
                                _root.chaps == 11
                            ) {
    ...
    trg.d.hs._visible =
        (trg.d.bo._currentframe == 16 ||
            trg.d.bo._currentframe == 17 ||
            trg.d.bo._currentframe == 18) &&
        trg.d.bo.d._currentframe != 2;
...
function soundfra() {
    ...
    if (_root.musicoff || _root.fade) {
        ...
        (_currentframe != 1 && _root._currentframe <= 5) ||
        _currentframe == 20 ||
        _currentframe == 21 ||
        _currentframe == 24 ||
        _currentframe == 41
        ...
        if (_root.musc.nam != undefined && !fader) {
            ...
            if (
                (_currentframe == 20 || _currentframe == 21) &&
                _root.musc.nam != "credits1-0.mp3" &&
                _root.musc.nam != "credits1-1.mp3" &&
                _root.musc.nam != "m11-0.mp3" &&
                _root.musc.nam != "m11-1.mp3"
    ...
    for (e in sz) {
        ...
        if (
            _root.musc == trg &&
            trg.wining &&
            trg.s.duration - 2500 < trg.s.position
        ) {
            _root.musc = undefined;
        }
        ...
        if (
            (trg.s.duration == trg.s.position && !trg.looper && !trg.looper2) ||
            trg.done
        ) {
            if (_root.mmus == trg) {
                _root.mmus = undefined;
...
function qshow() {
    ...
    while (z < 4) {
        trg = _root.paus["bq" + z];
        if (f1[z] == qqua || (z == 3 && qqua == undefined)) {
            trg.gotoAndStop(1);
        } else {
            trg.gotoAndStop(2);
        }
...
let onEnterFrame_init = () => {
    ...
    if (
        Key.isDown(32) &&
        ((_currentframe == 3 && d._currentframe > 5) ||
            (_currentframe == 4 && d._currentframe > 21))
    ) {
        _root.gotoAndStop("game");
        _root.fade = true;
    }
    ...
    if (
        ...
        (_currentframe == 21 ||
            _currentframe == 7 ||
            (_root.creskip && _currentframe == 20)) &&
        !ffs1
    ) {
        _root.creskip = false;
    ...
    if (
        Key.isDown(32) &&
        ((_currentframe > 9 && _currentframe < 20) ||
            _currentframe == 22 ||
            _currentframe == 23) &&
        !ffs1
    ) {
